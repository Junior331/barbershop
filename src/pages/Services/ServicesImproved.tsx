...
// Store para manter serviços selecionados
interface SelectedService extends Service {
  selectedBarbers?: string[]; // IDs dos barbeiros selecionados para este serviço
}

export const ServicesImproved = () => {
  ...
  const toggleService = (service: Service) => {
    setSelectedServices(prev => {
      ...
      if (isSelected) {
        ...
        // Adicionar serviço
        return [...prev, { ...service, selectedBarbers: [] }];
      }
    });
  };
    ...
    <Layout>
      <div className="flex flex-col justify-start items-center h-full w-full">
        ...
        <div className="flex flex-col w-full justify-between items-start gap-2 px-4 pb-2 overflow-auto h-[calc(100vh-0px)]">
                      ...
                      <div className="flex items-center w-full h-auto flex-1 relative">
                        ...
                        <div className="flex flex-col justify-start items-start w-full h-auto gap-2 flex-grow pl-2">
                          ...
                          <Text className={cn(
                            ...
                            {service.barbersCount} barbeiro{service.barbersCount !== 1 ? 's' : ''} disponível{service.barbersCount !== 1 ? 'is' : ''}
                          </Text>
          ...
          <div className="bottom-0 sticky w-full bg-white border-t pt-4">
            ...
            >
              {selectedServices.length
                ? `Continuar (${selectedServices.length}) • ${formatter({
                    type: "pt-BR",
                    currency: "BRL",
                    style: "currency",
                    minimumFractionDigits: 2,
